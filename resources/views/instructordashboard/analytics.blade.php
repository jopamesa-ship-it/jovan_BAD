...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ url('/instructor/analytics') }}" class="active"><i class="fas fa-chart-line"></i> Analytics</a></li>
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div>
                ...
                <small class="text-muted">Course performance insights</small>
            </div>
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p>Overview of all course performance metrics</p>
                </div>
                <div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="chart-card">
                    ...
                    <div class="mt-3 text-center text-muted">
                        <p>Interactive chart visualization would be displayed here using Chart.js</p>
                    </div>
                </div>

                <div class="chart-card">
                    <h5 class="mb-3">Assignment Submission Trends</h5>
                    <canvas id="submissionChart" height="80"></canvas>
                    <div class="mt-3 text-center text-muted">
                        <p>Line chart showing submission rates over time</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="chart-card">
                    ...
                    <div class="mt-3 text-center text-muted">
                        <p>Pie chart showing student distribution across courses</p>
                    </div>
                </div>
